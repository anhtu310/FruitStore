                    ...
                    <tbody>
                        <c:forEach items="${listO}" var="f">
                            <tr>
                                ...
                                <td>${f.isPaid}</td>
                                <td>
                                    <a href="load?fid=" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="delete?fid=" class="delete" data-toggle="modal" onclick="return confirm('Are you sure you want to delete this product?') && showAlert();"> <i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i> </a> <script> function showAlert() {
